...
!    Arguments :-
SUBROUTINE sf_expl (  halo_i,halo_j,off_x,off_y,row_length,rows,n_rows,  &
 land_pts,land_pts_trif,npft_trif,  dim_cs1, dim_cs2,  &
...
INTEGER  ilayers ,numcycles,cycleno ,dim_cs1, dim_cs2      ! soil carbon dimensions
...
!Jupp EXTERNAL tilepts,physiol,heat_con,sf_exch,snowtherm,              &
!Jupp swap_bounds,fill_external_halos,p_to_u,p_to_v
!Jupp EXTERNAL timer
...
! NEEDS TO BE DONE IN ATMOS_PHYSICS2 !!!
!      DO J=1,ROWS
!       DO I=1,ROW_LENGTH
!           FLANDG(I,J)=0.0
!       ENDDO
...
!$TAF STORE gs,l_q10,tile_index,tile_pts = tape_n_sfe, REC = iloopcount 
...
CALL physiol (                                                    &
 ...
 lai_ft,pstar,qw_1,sthu,t_soil(:,1),tstar_tile,                   & !Luke changed in line with Sitch/HadGEM2
...
!$TAF STORE canhc_tile,flake,gc,vfrac_tile = tape_n_sfe, REC = iloopcount 
