...
!Jupp  NAMELIST /urban_switches/ l_urban2T, l_moruses_albedo,                      &
!Jupp     l_moruses_emissivity, l_moruses_rough, l_moruses_storage,                &
!Jupp     l_moruses_storage_thin, l_moruses_macdonald, l_urban_empirical
