...
!Jupp EXTERNAL surf_hyd,soil_hyd,soil_htc,ice_htc,soilmc,               &
!Jupp         calc_baseflow_jules,soilt,ch4_wetl,timer

! End of header--------------------------------------------------------

hf_snow_melt(:) = 0.0 !Jupp hack otherwise output variable is undefined
smc(:)          = 0.0
qbase_zw(:)     = 0.0
fch4_wetl(:)    = 0.0
...
!Jupp
!write(*,*) 'hydrol line 308 : ',iloopcount
!$TAF STORE dsmc_dt,sthu,sthf,can_wcnt = tape_n, REC = iloopcount
!Jupp
...
END IF
!Jupp
!write(*,*) 'hydrol line 369 : ',iloopcount
!$TAF STORE qbase_l,top_crit = tape_n, REC = iloopcount
!Jupp
...
!Jupp
!write(*,*) 'hydrol line 393 : ',iloopcount
!$TAF STORE smcl,sthu = tape_n, REC = iloopcount
!Jupp

!$TAF INCOMPLETE smcl,w_flux

CALL soil_hyd (npnts,nshyd,soil_pts,soil_index,b,dzsoil,          &
               ext,dsmc_dt,satcon(npnts,0),ksz,sathh,timestep,v_sat, &
...
END IF
!Jupp
!write(*,*) 'hydrol line 447 : ',iloopcount
!$TAF STORE smcl,w_flux = tape_n, REC = iloopcount
!Jupp
!-----------------------------------------------------------------------
...
! DEPENDS ON: soil_htc
!Jupp
!write(*,*) 'hydrol line 456 : ',iloopcount
!$TAF STORE sthf,sthu,tsoil = tape_n, REC = iloopcount
!Jupp
...
!Jupp
! write(*,*) 'hydrol line 465 : ',iloopcount
!blah  !$TAF STORE tsoil = tape_n, REC = iloopcount
! !Jupp
