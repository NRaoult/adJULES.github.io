...
!-----------------------------------------------------------------------
!Jupp  NAMELIST /jules_switches/ l_point_data,l_snow_albedo,l_phenol,  &
!Jupp                            l_triffid,l_vg_soil,l_aggregate,      &
!Jupp                        can_model,soilhc_method,              &
!Jupp                            i_modiscopt,                          & 
!Jupp                            frac_snow_subl_melt,all_tiles,        &
!Jupp                            can_rad_mod, cor_mo_iter,             &
!Jupp                            iseaz0t, buddy_sea,                   &
!Jupp                            iscrntdiag, b_pdm, dz_pdm
