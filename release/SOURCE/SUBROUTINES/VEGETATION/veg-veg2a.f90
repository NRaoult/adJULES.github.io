...
USE timeConst, ONLY  : iSecInDay !Jupp
use time_loc, only : timestep    !Jupp
...
!Jupp
!write(*,*) 'veg2a line 331: ',iloopcount/(INT(REAL(iSecInDay)*TRIFFID_PERIOD/TIMESTEP)) 
!$TAF STORE frac,g_leaf_ac,ht,lai,tile_index,tile_pts = tape_veg2a, REC = iloopcount/      &
!$TAF       (INT(REAL(iSecInDay)*TRIFFID_PERIOD/TIMESTEP))
!Jupp
...
!Jupp
!write(*,*) 'veg2a line 405: ',iloopcount/(INT(REAL(iSecInDay)*TRIFFID_PERIOD/TIMESTEP)) 
!$TAF STORE resp_s_dr,cs,frac = tape_veg2a, REC = iloopcount/      &
!$TAF       (INT(REAL(iSecInDay)*TRIFFID_PERIOD/TIMESTEP))
!Jupp
  ...
  DO l=1,land_pts
    ...
    resp_s_dr(l,5)=0.0 !jupp hack
  END DO

!Jupp
!write(*,*) 'veg2a line 419: ',iloopcount/(INT(REAL(iSecInDay)*TRIFFID_PERIOD/TIMESTEP)) 
!$TAF STORE tile_index, tile_pts = tape_veg2a, REC = iloopcount/      &
!$TAF       (INT(REAL(iSecInDay)*TRIFFID_PERIOD/TIMESTEP))
!Jupp
...
!Jupp
!write(*,*) 'veg2a line 438: ',iloopcount/(INT(REAL(iSecInDay)*TRIFFID_PERIOD/TIMESTEP)) 
!$TAF STORE tile_index, tile_pts = tape_veg2a, REC = iloopcount/      &
!$TAF       (INT(REAL(iSecInDay)*TRIFFID_PERIOD/TIMESTEP))
!Jupp
...
!Jupp
!write(*,*) 'veg2a line 460: ',iloopcount/(INT(REAL(iSecInDay)*TRIFFID_PERIOD/TIMESTEP)) 
!$TAF STORE npp_dr,resp_w_dr = tape_veg2a, REC = iloopcount/      &
!$TAF       (INT(REAL(iSecInDay)*TRIFFID_PERIOD/TIMESTEP))
!Jupp
...
!Jupp    WRITE(6,*) 'Calling TRIFFID'
!Jupp
!write(*,*) 'veg2a line 531: ',iloopcount/(INT(REAL(iSecInDay)*TRIFFID_PERIOD/TIMESTEP)) 
!$TAF STORE  cs,frac,ht,lai,npp_dr,resp_s_dr,resp_w_dr           &
!$TAF     = tape_veg2b, REC= kiter*(iloopcount/                  &
!$TAF       (INT(REAL(iSecInDay)*TRIFFID_PERIOD/TIMESTEP))-1) + k
!Jupp
! DEPENDS ON: triffid
