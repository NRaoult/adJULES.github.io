...
! re-written to enable this.
  ...
  ! The following are not used if appropriate MORUSES switch used
     ...
     ! Emissivity
     emis_c      = 0.97,     & ! Canyon
     emis_rf     = 0.97        ! Jupp Roof ( This is used regardless of switch )
...
!Jupp  NAMELIST /urban2t_param/ albsnc_c, albsnc_rf, albsnf_c, albsnf_rf,         &
!Jupp     catch_c, catch_rf, gs_c, gs_rf, infil_c, infil_rf, z0_c, z0_rf,         &
!Jupp     z0h_z0m_c, z0h_z0m_rf, ch_c, ch_rf, vf_c, vf_rf, emis_c, emis_rf,       &
!Jupp     anthrop_heat_scale
