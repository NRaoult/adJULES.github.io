...
! Local declarations:
  REAL, PARAMETER :: alpha = 0.15 ! Exponent of decay of recirculation jet

  REAL ::           & ! Speed of jets along facets
     uu,            & ! Street: upstream
  ...
  REAL :: aloncan1, aloncan2, uu1, uct, vct, pi
...
! The 1E-3 is included for numerical reasons
  ...
  scaler6hat = MAX( 1e-3, ( bht - hs ) / wd ) ! Recirculation pathway (rbulk1)
  scaler6    = MAX( 1e-3,   hs         / wd ) ! Ventilation pathway   (rbulk2)
  scaler7    = MAX( 1e-3, ( wd - MIN( lr/2.0, wd ) ) / wd )
