...
! This routine is called twice for each output profile, to do different tasks.
  ...
  IF ( iout==1 .AND. callNumber==2 .and. echo) WRITE(*,"(50('-'),/,a)") & !Jupp
  'init_out_map call2' !Jupp
...
if (echo)  WRITE(*,"(50('-'),/,a)") 'init_out_map_land'
...
!-------------------------------------------------------------------------------
  ...
  if (echo) WRITE(*,"(50('-'),/,a)") 'init_out_map_compress'
