...
!    fsmc_l(i,n)=MAX(fsmc_l(i,n),0.0)                       ! original code
!    fsmc_l(i,n)=MIN(fsmc_l(i,n),1.0)                       ! original code
   
    fsmc_l(i,n)=softmax(fsmc_l(i,n),0.0,10.0)               ! Luke
    fsmc_l(i,n)=softmin(fsmc_l(i,n),1.0,20.0)               ! Luke
